1. History page: (LIVE — backed by /admin/notifications)
   ...
   - The action compoent should also be inside of the compose component, i do not know why you put it in a diff component.

# Note.

- No bloat.
- No Slop.
- Minimal code at all time, unless otherwise.
- add comment to code when so human and other model can understand, let comment look like the below (wrap it with the langs way of commenting)

.==================================
Comment msg goes here
.==================================

- Always crosscheck things before implementing them.
