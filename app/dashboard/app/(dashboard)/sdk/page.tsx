...
await notifi.sendNotification({
  ...
  body: "New message received",
    ...
    docs: links.sdkDocs["react-native"],
    status: "stable",
  },
  {
    id: "flutter",
