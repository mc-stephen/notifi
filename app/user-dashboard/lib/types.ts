...
// ---------------------------------------------------------------------------
// Billing (backed by GET/POST /app/billing/*). Limits are null = unlimited;
// prices are cents (null = custom / contact sales).
// ---------------------------------------------------------------------------
...
export type BillingYearlyDiscount = {
  kind: "percent" | "fixed";
  value: number;
};
...
export type BillingPlan = {
  ...
  currency: string;
  capabilities: BillingPlanCapability;
  yearlyDiscount: BillingYearlyDiscount | null;
...
export type ProjectSubscription = {
  ...
  /** Paid plan ends at periodEnd, then reverts to free. */
  cancelAtPeriodEnd: boolean;
  periodPriceCents: number | null;
  periodStart: string;
  periodEnd: string;
  usage: BillingUsage;
  updatedAt: string;
