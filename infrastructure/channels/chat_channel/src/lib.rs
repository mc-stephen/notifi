...
impl ChatSender {
    ...
    pub async fn send_message(&self, msg: &ChatMessage) -> Result<(), String> {
        ...
        match provider {
            providers::ChatProvider::Slack(c) => match c.auth {
                ...
                providers::slack::SlackAuth::BotApi {
                    bot_token,
                    channel_id,
                } => {
            ...
            providers::ChatProvider::Discord(c) => match c.auth {
                ...
                providers::discord::DiscordAuth::BotApi {
                    bot_token,
                    channel_id,
                } => {
                    let url = format!(
